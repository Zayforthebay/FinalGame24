...
public class gameManager : MonoBehaviour
{
    ...
    private int CountcoinsInLevel()
    {
        int count = 0;
        // select Parent Keys, loop through children, count children
        foreach (Transform coin in coinParentTransform) // For each Key object nested under the key parent object...
        {
    ...
    {
        playerCoins = 0;
        coinsInLevel = CountcoinsInLevel();
